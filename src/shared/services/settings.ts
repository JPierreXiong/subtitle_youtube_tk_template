...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      tip: 'Required for R2. Find it in Cloudflare Dashboard -> R2 -> Overview',
      group: 'r2',
      tab: 'storage',
    },
    {
    ...
    },
    {
      ...
      tip: 'Select the default storage provider for video uploads',
      group: 'storage',
      tab: 'storage',
    },
    {
      ...
      tip: 'Get this from Vercel Dashboard -> Storage -> Blob -> Connect',
      group: 'vercel-blob',
      tab: 'storage',
    },
    {
    ...
    {
      name: 'rapidapi_media_key',
      title: 'RapidAPI Media Key',
      type: 'password',
      placeholder: '558c577f30msh4f4e14fdc702b0cp1cf611jsn339fa91dba2b',
      group: 'openrouter',
      tip: 'RapidAPI Key for TikTok and YouTube media extraction',
      tab: 'ai',
    },
    {
      ...
      type: 'password',
      placeholder: 'AIzaSyCA-W43UHCzRUUKM5ny9kdgPAtTL0dHvLY',
      group: 'openrouter',
      tip: 'Google Cloud Translation API Key for subtitle translation',
      tab: 'ai',
    },
    {
      name: 'gemini_api_key',
      ...
      type: 'password',
      placeholder: 'AIzaSyD-kp-66sGmHLwaj1P_UgLCB4_7Q8z8yu0',
      group: 'openrouter',
      tip: 'Google Gemini API Key for AI subtitle translation',
      tab: 'ai',
    },
    {
      name: 'adsense_code',
